...
Project-local Pi harness with sandbox, subagent, ask mode, plan mode, model
routing, question, statusline, and todo extensions.
...
| [ask](extensions/ask/README.md) | Read-only Q&A mode with guarded tools |
